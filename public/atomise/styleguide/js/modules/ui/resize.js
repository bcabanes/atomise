...
(function(atomiseUI){
  ...
  var setSmall = function(e){
    ...
    Atomise.event.send('ui:setSmall');
  ...
  var setMedium = function(e){
    ...
    Atomise.event.send('ui:setMedium');
  ...
  var setLarge = function(e){
    ...
    Atomise.event.send('ui:setLarge');
  ...
  var setRandom = function(e){
    ...
    Atomise.event.send('ui:setRandom');
  ...
  var handlePulls = function(event){
    ...
    $sgCapture.mousemove(function(event){
      ...
      if(viewportWidth > minViewportWidth){
        if(!Atomise.data.get('viewportWidth')){
          Atomise.data.add('viewportWidth', viewportWidth);
        }else{
          Atomise.data.update('viewportWidth', viewportWidth);
        }
  ...
  var saveSize = function(size){
    if(!Atomise.data.get('viewportWidth')){
      Atomise.data.add('viewportWidth', size);
    }else{
      Atomise.data.update('viewportWidth', size);
    }
  };
