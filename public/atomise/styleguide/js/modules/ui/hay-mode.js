...
(function(atomiseUI){
  ...
  var startHayMode = function(){
    enabled = true;
    Atomise.event.send('ui:hayMode:started');
    ...
    var timeoutID = window.setTimeout(function(){
      ...
      setInterval(function(){
        ...
        atomiseUI.resize.updateSizeReading(vpsize);
      }, 100);
    }, 200);
  };
  ...
  var stopHayMode = function(){
    var currentWidth = $sgViewport.width();
		...
		atomiseUI.resize.resize(Math.floor(currentWidth));
    Atomise.event.send('ui:hayMode:stopped');
  };
